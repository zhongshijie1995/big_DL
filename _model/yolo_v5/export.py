...
Usage:
    $ python export.py --weights yolo_v5.pt --include torchscript onnx openvino engine coreml tflite ...

Inference:
    $ python detect.py --weights yolo_v5.pt                 # PyTorch
...
def run(
        ...
        weights=ROOT / 'yolo_v5.pt',  # weights path
...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'yolo_v5.pt', help='model.pt path(s)')
